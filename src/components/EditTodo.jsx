...
const EditTodo = ({todo}) => {
    ...
    const updateDescriptio =(e)=>async (e)=> {
        e.preventDefault()
        try {
...
<button type="button" className="btn btn-warning" data-toggle="modal" data-target={`#id${todo.tod_id}`}>
  Edit
</button>
  ...
  <div className="modal-dialog">
    <div className="modal-content">
      ...
      <div className="modal-footer">
        ...
        onclick={(e)=> updateDescriptio(e)}>Edit</button>
      </div>
